// AUTO-GENERATED by scripts/generate-public.mjs. Do not edit by hand.
// Re-run `node scripts/generate-public.mjs` after changing items-*.ts.
//
// Public-only metadata for the 58 launch-readiness checklist items.
// Used by the SPA bundle so paid-tier content (prompt, what, why,
// steps, redFlags, references, cliPrompt) never ships to anonymous
// browsers. The full data lives in src/index.ts and is consumed
// server-side by api-server/CLI/internal-audit only.
