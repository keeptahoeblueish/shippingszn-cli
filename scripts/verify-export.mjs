...
for (const requiredChecklistPath of [
  "src/vendor/checklist-data/index.ts",
  "src/vendor/checklist-data/types.ts",
]) {
  if (!manifestPaths.includes(requiredChecklistPath)) {
    fail(`free finding remediation source is missing: ${requiredChecklistPath}`);
  }
}
